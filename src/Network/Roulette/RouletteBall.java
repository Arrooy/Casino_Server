...
public class RouletteBall {
     ...
     */
    public RouletteBall(double x, double y, double centerX, double centerY, RouletteManager c, double limit, double intLim) {
        this.x = x;
        this.y = y;
    ...
    /** Getter de la velocitat inicial */
    public static double getInitVel() {
        return initVel;
    }
